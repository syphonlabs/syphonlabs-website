...
export const metadata: Metadata = {
  title: { absolute: "Syphon Labs | Building Scalable AI Solutions: Lessons Learned" },
  description:
    "Insights from developing AI tools that scale from individuals to enterprises—architecture, performance, and reliability.",
