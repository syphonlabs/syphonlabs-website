...
import { ArrowLeft, Upload, FileText, Download, Clock, Zap, Target, CheckCircle, Star, Shield, MessageCircle } from "lucide-react"
        ...
        <section className="relative overflow-hidden py-20 md:py-32 bg-gradient-to-b from-white to-violet-50">
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              >
                Syphon <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600 animate-gradient-x">Draft</span>
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4 mb-6 justify-items-center text-left max-w-3xl mx-auto">
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-gray-600">
                Try the demo below to see how Syphon Draft generates a tailored resume and cover letter in seconds.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-b from-white to-violet-50">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-gray-600">
                Three simple steps to get your optimized resume and cover letter
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                },
                {
                  step: "2",
                  title: "AI Analysis",
                  description: "Our AI analyzes both documents to understand requirements and optimize your content.",
                  icon: <Zap className="h-6 w-6" />
                },
                {
                  step: "3",
                  title: "Download Results",
                  description: "Get your optimized resume and cover letter ready for submission in under 60 seconds.",
                ...
                >
                  <div className="h-16 w-16 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
